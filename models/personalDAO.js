...
var personalDAO = {
  ...
  getPersonalManyInfo: function(userId, callback) {
    console.log(userId)
    DAO(
      'select base_info_Id,nickName,age,sex,constellation,love_description,birthday,hobby,choose_object,province,city,location_detail,marriage,love_affair,body_status,height,weight,education,occupation,salary,blight,house,car,integral,headPic from base_info where base_info_Id = ?',
      [userId],
  ...
  getThirdSweet: function(userId, callback) {
    console.log(userId)
    DAO('select base_info_Id,nickName,headPic,sex,love_description,blight,hobby,height,weight,occupation,birthday,choose_object,body_status from base_info where base_info_Id = ?', [userId], function(
      err,
      results
    ) {
      if (err) {
  ...
  getFourthSweet: function(userId, callback) {
    console.log(userId)
    DAO(
      'select base_info_Id,nickName,headPic,sex,love_description,blight,hobby,height,weight,occupation,birthday,choose_object,body_status,education,marriage,salary from base_info where base_info_Id = ?',
      [userId],
      function(err, results) {
        if (err) {
          callback(err, null)
  ...
  getFifthSweet: function(userId, callback) {
    console.log(userId)
    DAO(
      'select base_info_Id,nickName,headPic,sex,love_description,blight,hobby,height,weight,occupation,birthday,choose_object,body_status,education,marriage,salary,province,city,love_affair from base_info where base_info_Id = ?',
      [userId],
      function(err, results) {
        if (err) {
          callback(err, null)
  ...
  getSixthSweet: function(userId, callback) {
    console.log(userId)
    DAO(
      'select base_info_Id,nickName,headPic,sex,love_description,blight,hobby,height,weight,occupation,birthday,choose_object,body_status,education,marriage,salary,province,city,love_affair,car,house,telephone from base_info where base_info_Id = ?',
      [userId],
      function(err, results) {
        if (err) {
          callback(err, null)
