        ...
        <div class="work-box">
          <a href="http://localhost:3000/olove/work-1.jpg" data-lightbox="gallery-mf">
            ...
            <div class="work-content">
              <div class="row">
                <div class="col-sm-12">
                  <h2 class="w-title">rose</h2>
                  <p>
                    <span class="w-date">单价</span>
                    <span class="w-date">￥29</span>
                  </p>
                  <div class="w-more">
                    <span
                      class="w-ctegory"
                    >传说玫瑰花伴随着爱与美的女神阿佛洛狄忒诞生于爱琴海中，成为了美神的化身，而且又溶入了爱神的血液。让其赋予了深厚的情感寓意，随着时间的慢慢推移，这种情感寓意就被人们公认为是玫瑰花花语的初始</span>
                  </div>
                  <div>
                    <el-input-number
                      v-model="num"
          ...
          <div class="product bordser">
            ...
            <div class="product-footer">
              <div class="row">
                ...
                <div class="col-md-6">
                  <button type="button" :name="key.prop_Id" class="btn btn-outline-secondary btn-sm" @click.prevent="Buy(key.prop_price,key.prop_Id)">直接购买</button>
