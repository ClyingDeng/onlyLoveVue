...
<template>
    ...
    <div class="member-type">
      <div class="open-member">
        ...
        <div class="detail-type">
          ...
          <p  class="memberphoto"><img src="../assets/imgs/huiyuan-.png" alt="">唯爱会员</p>
          
          <p >全球共1亿人正通过唯爱会员来寻找自己的生活伴侣</p><br>
          <p class="save-member">
            <!-- <span @click="buymember()">续费会员</span> -->
             <el-button type="text" @click="open" style="color:coral;">续费会员</el-button>
 ...
 <span>搜索条件:</span><el-progress style="margin-top:10px;"  :text-inside="true" :stroke-width="24" :percentage="70" status="success"></el-progress>
  </div> 
  <div>
<span>优惠折扣:</span><el-progress style="margin-top:10px;" :text-inside="true" :stroke-width="22" :percentage="88" status="warning"></el-progress>
</div>
          </div>
        </div>
