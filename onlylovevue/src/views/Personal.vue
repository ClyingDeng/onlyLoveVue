                ...
                <div class="side-bar">
                    <div class="user-info">
                        ...
                        <ul class="meta list list-unstyled">
                            ...
                            <li class="email"><a href="#">1174915260@qq.com</a></li>
                            <li class="activity">上次登录时间:  <br />今天下午 2:18</li>
                        </ul>
                    </div>
            		<nav class="side-menu">
        				<ul class="nav">
        					<li class="active"><a href="#"><span class="fa fa-user"></span>个人信息</a></li>
        					<li><a href="#"><span class="fa fa-cog"></span>设置</a></li>
        					<li><a href="#"><span class="fa fa-credit-card"></span> 实名认证</a></li>
